...
var translate = function (e) {
    ...
    switch (e.keyCode) {
        case 52:
            objects[index].x -= deltatrans;
            break;     // translation x --
        case 54:
            objects[index].x += deltatrans;
            break;     // translation x ++
        case 50:
            objects[index].y -= deltatrans;
            break;	// translation y --
        case 56:
            objects[index].y += deltatrans;
            break;   // translation y ++
        case 57:
            objects[index].z -= deltatrans;
            break;	// translation z --
        case 55:
            objects[index].z += deltatrans;
            break;	// translation z ++
        //////////Rotation////////
        case 88:
            objects[index].rx += deltarot;
            break;		//  rx ++
        case 120:
            objects[index].rx -= deltarot;
            break;		//	rx --
        case 89:
            objects[index].ry += deltarot;
            break;		// 	ry ++
        case 121:
            objects[index].ry -= deltarot;
            break;		//	ry--
        case 90:
            objects[index].rz += deltarot;
            break;		//	rz++
        case 122:
            objects[index].rz -= deltarot;
            break;		//	rz--
        ...
        ///////////////////////////Scaling///////////////
        case 106:
            objects[index].sx /= deltascale;
            break;// x scale --
        case 108:
            objects[index].sx *= deltascale;
            break;// x scale ++
        case 107:
            objects[index].sy /= deltascale;
            break;// y scale --
        case 105:
            objects[index].sy *= deltascale;
            break;// y scale ++
        case 111:
            objects[index].sz /= deltascale;
            break;// z scale --    // o
        case 117:
            objects[index].sz *= deltascale;
            break;// z scale ++   // u
    ...
    if (shape == "cube") {
        ...
        for (j = 0; j <= 2 * SPHERE_DIV; j++) {
            ...
            for (i = 0; i <= SPHERE_DIV; i++) {
                ...
                vertices.push((i % j) / 20);
                vertices.push((i % j) / 17);
                vertices.push((i % j) / 15);  // colors
